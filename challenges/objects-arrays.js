...
zooAnimals.forEach(animal => displayNames.push(`Name:${animal.name}, Scientific:${animal.scientific_name}`));
...
*/
const populationTotal = zooAnimals.map(ani => ani.population);

console.log(populationTotal.reduce((accumulate, current) => accumulate + current, 0));
